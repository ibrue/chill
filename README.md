...
The fan-on-gradient icon is generated by `scripts/generate_app_icon.py`. Re-run it (requires `pip install Pillow`) to regenerate every macOS slot from a 1024×1024 master.
